...
// CelebrationFx (confetti + balloons) now lives in ./CelebrationFx.tsx --
// extracted so PremiumResultScreen can reuse the exact same effect for a
// high-score celebration. Skipped entirely under prefers-reduced-motion,
// same as before (see `!reduced && <CelebrationFx />` below).
